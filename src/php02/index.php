...
echo "それでは、ゲームスタートです。大富豪を目指して頑張りましょう。" . PHP_EOL;
echo "まず、職業を決めましょう。" . PHP_EOL;
...
for($event_count=1; $event_count<=10; $event_count++){
    ...
    if($asset>=2000){
    echo "" . PHP_EOL;
    echo "{$asset}万円溜まった。何かやってみようか？" . PHP_EOL;
    echo "1:車を買う" . PHP_EOL;
